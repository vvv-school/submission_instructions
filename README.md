...
- :arrow_up: [**Upload**](https://help.github.com/articles/adding-a-file-to-a-repository) to your new repository the required files as specified in [`./uploads`](./uploads):
